...
namespace Tileon::Editor
{
    ...
    Bootstrap::Result Bootstrap::Draw()
    {
    ...
    Bootstrap::Result Bootstrap::DrawInMenu()
    {
    ...
    Bootstrap::Result Bootstrap::DrawInWizard()
    {
    ...
    {
        mPicker.Open(Toolkit::Picker::Mode::Open, Filesystem::GetRootFolder(), Project::kFileExtension,
            [this](Text Path)
            {
                OnDialogResult(Path);
            });
    ...
    {
        mPicker.Open(Toolkit::Picker::Mode::Save, Filesystem::GetRootFolder(), Project::kFileExtension,
            [this](Text Path)
            {
                OnDialogResult(Path);
            });

...
namespace Tileon::Editor
{
    ...
    private:
        ...
        Handle DrawMove(ConstRef<Lens> Lens, ImVec2 Anchor) const;

        /// \brief Draws the rings that turn the entity, and reports which one the cursor wants.
        ///
        /// \param Lens     The lens the rings are projected through.
        /// \param Anchor   The entity's position, in screen space.
        /// \return The handle under the cursor, or `Handle::None`.
        Handle DrawRotate(ConstRef<Lens> Lens, ImVec2 Anchor) const;
        ...
        /// \param Anchor   The entity's position, in screen space.
        /// \return The handle under the cursor, or `Handle::None`.
        Handle DrawScale(ConstRef<Lens> Lens, ImVec2 Anchor) const;

...
namespace Tileon::Editor
{
    ...
    concept IsInspectable = requires (Ref<Workspace> Workspace, Scene::Entity Actor, Ref<Type> Component)
    {
    ...
    public:
        ...
        ZY_INLINE ComponentType() = default;
        ...
        ZY_INLINE ComponentType(Handler Inspector, Text Label, Text Icon, Text Group, Scope Scope)
    ...
    public:
        ...
        /// \brief Creates a `ComponentType` bound to a specific component type.
        ///
        /// \param Label The human-readable name displayed for the component.
        /// \param Icon  The glyph displayed alongside the label.
        /// \param Group The category the component is filed under in the catalog.
        /// \param Scope The kind of entity the component may be authored on.
        /// \return A fully initialized `ComponentType` ready to draw instances of `Component`.
        template<typename Component>
        ZY_INLINE static ComponentType Create(Text Label, Text Icon, Text Group, Scope Scope)
        {
            if constexpr (IsInspectable<Component>)
            {
                return ComponentType(OnInspect<Component>, Label, Icon, Group, Scope);
            }
            else
            {
                return ComponentType(nullptr, Label, Icon, Group, Scope);
            }
        }

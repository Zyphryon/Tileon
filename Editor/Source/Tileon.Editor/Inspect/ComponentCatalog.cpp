...
namespace Tileon::Editor
{
    ...
    ComponentCatalog::ComponentCatalog(Ref<Scene::Service> Scene)
        : mScene { Scene }
    {
        OnRegister();
    }
    ...
    void ComponentCatalog::OnRegister()
    {
        mScene.Register(Scene::DSL::Declare<ComponentType>(Scene::DSL::Final));
        ...
        Add<Unlit>      ("Unlit",       ICON_FA_MOON,                   "Unlit");

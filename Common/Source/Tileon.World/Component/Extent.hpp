...
namespace Tileon
{
    /// \brief Represents the extent of an entity, defined by its offset and size.
    class Extent final
    {
    public:
        ...
        /// \param Size   The size of the extent, representing the dimensions of the entity.
        ...
        ///
        /// \param Size The size to set for the extent, representing the dimensions of the entity.
        ...
        ///
        /// \return The size of the extent, representing the dimensions of the entity.
        ...
        ///
        /// \param Offset The offset to set for the extent, representing the position relative to the entity's origin.
        ...
        ///
        /// \return The offset of the extent, representing the position relative to the entity's origin.
